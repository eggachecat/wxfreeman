! function(e) {
    ...
    return t.e = function(e, n) {
        ...
        if (void 0 !== i[e]) i[e].push(n);
            ...
            o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.src = t.p + "/static/js/1e849768c925a1632ff3_" + e + ".js", r.appendChild(o)
        }
    }, t.m = e, t.c = r, t.p = "//res.wx.qq.com/a/wx_fed/webwx/res", t(0)
}({
    0: function(e, exports, t) {
        t(285), t(289), t(290), t(291), t(292), t(293), t(294), t(295), e.exports = t(296)
    },
    285: function(e, exports, t) {
        (function(n) {
            e.exports = n.$ = t(286)
    ...
    286: function(e, exports, t) {
        (function(n) {
            e.exports = n.jQuery = t(287)
        }).call(exports, function() {
            return this
        }())
    },
    287: function(e, exports, t) {
        ...
        ! function(t, n) {
            ...
            function x(e, t) {
                ...
                if (!o)
                    for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || ce.nodeName(r, t) ? o.push(r) : ce.merge(o, x(r, t));
            ...
            ce.fn = ce.prototype = {
                ...
                var e, t, n, r, i, o, a = arguments[0] || {},
                    ...
                    l = arguments.length,
                    u = !1;
                for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || ce.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++)
                    if (null != (i = arguments[s]))
                        for (r in i) e = a[r], n = i[r], a !== n && (u && n && (ce.isPlainObject(n) || (t = ce.isArray(n))) ? (t ? (t = !1, o = e && ce.isArray(e) ? e : []) : o = e && ce.isPlainObject(e) ? e : {}, a[r] = ce.extend(u, o, n)) : void 0 !== n && (a[r] = n));
                return a
            }, ce.extend({
                ...
                globalEval: function(e) {
                    e && ce.trim(e) && (i.execScript || function(e) {
                        i.eval.call(i, e)
                    })(e)
                },
            ...
            var ve = function(e) {
                ...
                function m(e, t, n, i, o, a) {
                    return i && !i[V] && (i = m(i)), o && !o[V] && (o = m(o, a)), r(function(r, a, s, l) {
                        var u, c, f, p = [],
                            ...
                            b = n ? o || (r ? e : d || i) ? [] : a : y;
                        if (n && n(y, b, s, l), i)
                            for (u = g(b, h), i(u, [], s, l), c = u.length; c--;)(f = u[c]) && (b[h[c]] = !(y[h[c]] = f));
                        if (r) {
                            if (o || e) {
                                if (o) {
                ...
                function y(e) {
                    for (var t, n, r, i = e.length, o = C.relative[e[0].type], a = o || C.relative[" "], s = o ? 1 : 0, l = h(function(e) {
                        ...
                        if (n = C.relative[e[s].type]) c = [h(d(c), n)];
                        else {
                ...
                w = t.support = {}, T = t.isXML = function(e) {
                    ...
                    }), L = L.length && new RegExp(L.join("|")), I = I.length && new RegExp(I.join("|")), t = $.test(P.compareDocumentPosition), F = t || $.test(P.contains) ? function(e, t) {
                            ...
                            return 1 === r && 0 === i ? function(e) {
                                ...
                                if (g) {
                                    ...
                                    if (d = [a ? g.firstChild : g.lastChild], a && y) {
                                        for (c = g[V] || (g[V] = {}), u = c[e] || [], h = u[0] === W && u[1], p = u[0] === W && u[2], f = h && g.childNodes[h]; f = ++h && f && f[v] || (p = h = 0) || d.pop();)
                    ...
                    pseudos: {
                        ...
                        lang: r(function(e) {
                            return ve.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(xe, we).toLowerCase(),
                                function(t) {
                                    var n;
                                    do
            ...
            var ye, be = i.document,
                ...
                we = ce.fn.init = function(e, t) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        if (n[1]) {
                            if (t = t instanceof ce ? t[0] : t, ce.merge(this, ce.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : be, !0)), me.test(n[1]) && ce.isPlainObject(t))
            ...
            ce.extend({
                ...
                closest: function(e, t) {
                    for (var n, r = 0, i = this.length, o = [], a = ge.test(e) || "string" != typeof e ? ce(e, t || this.context) : 0; i > r; r++)
            ...
            ce.Callbacks = function(e) {
                ...
                when: function(e) {
                    ...
                    if (a > 1)
                        for (t = new Array(a), n = new Array(a), r = new Array(a); a > i; i++) o[i] && ce.isFunction(o[i].promise) ? o[i].promise().done(u(i, r, o)).fail(l.reject).progress(u(i, n, t)) : --s;
            ...
            ce.fn.ready = function(e) {
                ...
                if (!Ae)
                    if (Ae = ce.Deferred(), "complete" === be.readyState) setTimeout(ce.ready);
                ...
                remove: function(e, t, n, r, i) {
                    ...
                    if (g && (c = g.events)) {
                        for (t = (t || "").match(Te) || [""], u = t.length; u--;)
                            if (s = _.exec(t[u]) || [], h = v = s[1], d = (s[2] || "").split(".").sort(), h) {
            ...
            }, ce.removeEvent = be.removeEventListener ? function(e, t, n) {
            ...
            Ze.optgroup = Ze.option, Ze.tbody = Ze.tfoot = Ze.colgroup = Ze.caption = Ze.thead, Ze.th = Ze.td, ce.extend({
                clone: function(e, t, n) {
                    ...
                    if (le.html5Clone || ce.isXMLDoc(e) || !He.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (tt.innerHTML = e.outerHTML, tt.removeChild(o = tt.firstChild)), !(le.noCloneEvent && le.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ce.isXMLDoc(e)))
                        for (r = x(o), s = x(e), a = 0; null != (i = s[a]); ++a) r[a] && k(i, r[a]);
                    if (t)
                        if (n)
                            for (s = s || x(e), r = r || x(o), a = 0; null != (i = s[a]); a++) A(i, r[a]);
                        else A(e, o);
                    return r = x(o, "script"), r.length > 0 && E(r, !l && x(e, "script")), r = s = i = null, o
                },
                buildFragment: function(e, t, n, r) {
                    for (var i, o, a, s, l, u, c, f = e.length, p = b(t), h = [], d = 0; f > d; d++)
                        if (o = e[d], o || 0 === o)
                        ...
                        if (!le.leadingWhitespace && We.test(o) && h.push(t.createTextNode(We.exec(o)[0])), !le.tbody)
                            for (o = "table" !== l || ze.test(o) ? "<table>" !== c[1] || ze.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) ce.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                        for (ce.merge(h, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                        s = p.lastChild
                    } else h.push(t.createTextNode(o));
                    for (s && p.removeChild(s), le.appendChecked || ce.grep(x(h, "input"), w), d = 0; o = h[d++];)
                        if ((!r || -1 === ce.inArray(o, r)) && (a = ce.contains(o.ownerDocument, o), s = x(p.appendChild(o), "script"), a && E(s), n))
                            for (i = 0; o = s[i++];) Je.test(o.type || "") && n.push(o);
                    return s = null, p
                },
                cleanData: function(e, t) {
                    for (var n, r, i, o, a = 0, s = ce.expando, l = ce.cache, u = le.deleteExpando, c = ce.event.special; null != (n = e[a]); a++)
                ...
                domManip: function(e, t) {
                    ...
                    if (u && (s = ce.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                        ...
                        if (i)
                            for (a = o[o.length - 1].ownerDocument, ce.map(o, T), l = 0; i > l; l++) r = o[l], Je.test(r.type || "") && !ce._data(r, "globalEval") && ce.contains(a, r) && (r.src ? ce._evalUrl && ce._evalUrl(r.src) : ce.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Ge, "")));
                        s = n = null
                    }
                    return this
                }
            ...
            i.getComputedStyle ? (it = function(e) {
                ...
                return n = n || it(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== a || ce.contains(e.ownerDocument, e) || (a = ce.style(e, t)), st.test(a) && at.test(t) && (r = s.width, i = s.minWidth,
                    ...
                    select: {
                        get: function(e) {
                            for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, l = 0 > i ? s : o ? i : 0; s > l; l++)
                                if (n = r[l], !(!n.selected && l !== i || (le.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && ce.nodeName(n.parentNode, "optgroup"))) {
                        ...
                        set: function(e, t) {
                            for (var n, r, i = e.options, o = ce.makeArray(t), a = i.length; a--;)
                                if (r = i[a], ce.inArray(ce.valHooks.option.get(r), o) >= 0) try {
                                    r.selected = n = !0
                                } catch (e) {
                                    r.scrollHeight
                                } else r.selected = !1;
            ...
            ce.fn.extend({
                ...
                removeAttr: function(e, t) {
                    var n, r, i = 0,
                        o = t && t.match(Te);
                    if (o && 1 === e.nodeType)
                        for (; n = o[i++];) r = ce.propFix[n] || n, ce.expr.match.bool.test(n) ? _t && Nt || !kt.test(n) ? e[r] = !1 : e[ce.camelCase("default-" + n)] = e[r] = !1 : ce.attr(e, n, ""), e.removeAttribute(Nt ? n : r)
                },
                attrHooks: {
                    type: {
                        set: function(e, t) {
                ...
                At[t] = _t && Nt || !kt.test(t) ? function(e, t, r) {
                    var i, o;
            ...
            ce.fn.extend({
                addClass: function(e) {
                    ...
                    if (u)
                        for (t = (e || "").match(Te) || []; l > s; s++)
                            if (n = this[s], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Mt, " ") : " ")) {
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ce.isFunction(e) ? function(n) {
                        ...
                        if ("string" === n)
                            for (var t, r = 0, i = ce(this), o = e.match(Te) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            ...
            }), ce.ajaxSettings.xhr = void 0 !== i.ActiveXObject ? function() {
                        ...
                        send: function(n, r) {
                            ...
                            o.send(e.hasContent && e.data || null), t = function(n, i) {
                                ...
                                if (t && (i || 4 === o.readyState))
                                    if (delete tn[a], t = void 0, o.onreadystatechange = ce.noop, i) 4 !== o.readyState && o.abort();
                                    else {
                ...
                ce.each({
                    ...
                    ce.fn[r] = function(r, i) {
                        ...
                        return Pe(this, function(t, n, r) {
                            var i;
                            return ce.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (i = t.documentElement,
                                Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : void 0 === r ? ce.css(t, n, a) : ce.style(t, n, r, a)
                        }, t, o ? r : void 0, o, null)
                    }
                })
            }), ce.fn.size = function() {
                return this.length
            }, ce.fn.andSelf = ce.fn.addBack, t(288) && (n = [], r = function() {
                return ce
    ...
    288: function(e, exports) {
        (function(t) {
            e.exports = t
        }).call(exports, {})
    },
    289: function(e, exports, t) {
        /**
        ...
        ! function(e, t, n) {
            ...
            function q(e, t) {
                ...
                if (a == s && "object" == a) {
                    if (!Mn(e)) {
                        ...
                        for (i in t)
                            if (!o.hasOwnProperty(i) && "$" !== i.charAt(0) && t[i] !== n && !S(t[i])) return !1;
                        return !0
                    }
                    if (!Mn(t)) return !1;
            ...
            function pe(e, t, n, r) {
                function i(e) {
                    ...
                    if (!r || null != e)
                        for (; p.length;)
                            for (i = p.shift(), a = 0, s = i.length; a < s; a++)
                                for (l = Cn(i[a]), h ? l.triggerHandler("$destroy") : h = !h, u = 0, c = (f = l.children()).length; u < c; u++) p.push(Sn(f[u]));
                ...
                function c(e) {
                    ...
                    return o(e, function(e) {
                        if (!m.get(e)) {
                            ...
                            try {
                                if (x(e))
                                    for (t = Tn(e), a = a.concat(c(t.requires)).concat(t._runBlocks), n = t._invokeQueue, r = 0, i = n.length; r < i; r++) {
                                        var o = n[r],
                                            s = w.get(o[0]);
                                        s[o[1]].apply(s, o[2])
            ...
            function Ie(e, t, r, i) {
                ...
                u.cookies = function(e, t) {
                    ...
                    if (!e) {
                        if (c.cookie !== D)
                            for (D = c.cookie, o = D.split("; "), N = {}, s = 0; s < o.length; s++) a = o[s], l = a.indexOf("="), l > 0 && (e = unescape(a.substring(0, l)), N[e] === n && (N[e] = unescape(a.substring(l + 1))));
                        return N
                    }
                ...
                this.directive = function t(n, r) {
                    ...
                    function O(e, t, n, r, i) {
                        ...
                        switch (l) {
                            case 1:
                                ...
                                if (a = e.className, x(a) && "" !== a)
                                    for (; o = u.exec(a);) h = We(o[2]), L(t, h, "C", r, i) && (n[h] = jn(o[3])), a = a.substr(o.index + o[0].length);
                                break;
                            case 3:
                                U(t, e.nodeValue);
                                break;
                    ...
                    function P(e, i, a, s, u, c, f, p, h) {
                        ...
                        for (var w, C, T, E, N, D, P = -Number.MAX_VALUE, L = h.controllerDirectives, W = h.newIsolateScopeDirective, U = h.templateDirective, z = h.nonTlbTranscludeDirective, X = !1, G = !1, Z = h.hasElementTranscludeDirective, te = a.$$element = Cn(i), ne = c, re = s, ie = 0, oe = e.length; ie < oe; ie++) {
                            ...
                            if ((D = C.scope) && (w = w || C, C.templateUrl || (B("new/isolated scope", W, C, te), b(D) && (W = C))), T = C.name, !C.templateUrl && C.controller && (D = C.controller, L = L || {}, B("'" + T + "' controller", L[T], C, te), L[T] = C), (D = C.transclude) && (X = !0, C.$$tlb || (B("transclusion", z, C, te), z = C), "element" == D ? (Z = !0, P = C.priority, E = te, te = a.$$element = Cn(t.createComment(" " + T + ": " + a[T] + " ")), i = te[0], Y(u, V(E), i), re = A(E, s, P, ne && ne.name, {
                                ...
                                })) : (E = Cn(me(i)).contents(), te.empty(), re = A(E, s))), C.template)
                                if (G = !0, B("template", U, C, te), U = C, D = S(C.template) ? C.template(te, a) : C.template, D = ee(D), C.replace) {
                    ...
                    function L(t, r, o, s, u, c, f) {
                        ...
                        if (i.hasOwnProperty(r))
                            for (var d, v = e.get(r + a), g = 0, m = v.length; g < m; g++) try {
                    ...
                    function U(e, t) {
                        ...
                        n && e.push({
                            ...
                            compile: function(e) {
                                var t = e.parent(),
                                    r = t.length;
                                return r && k(e.parent(), "ng-binding"),
                                    function(e, t) {
                                        var i = t.parent(),
                                            o = i.data("$binding") || [];
                ...
                this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, t, r, i, c, p) {
                    ...
                    function g(r, o, s) {
                        ...
                        var p, d, v = c.defer(),
                            g = v.promise,
                            x = w(r.url, r.params);
                        if (h.pendingRequests.push(r), g.then(f, f), !r.cache && !a.cache || r.cache === !1 || "GET" !== r.method && "JSONP" !== r.method || (p = b(r.cache) ? r.cache : b(a.cache) ? a.cache : T), p)
                            if (d = p.get(x), y(d)) {
                            ...
                            try {
                                for (var t, n = 0, a = g; n < a; n++) {
                                    if ("function" == typeof(t = v[n]))
                                        if (t = t(e), t = u ? i.getTrusted(u, t) : i.valueOf(t), null == t) t = "";
            ...
            function wt(e, t, r, i, o) {
                ...
                for (var a, s = t.split("."), l = 0; s.length > 1; l++) {
                    a = yt(s.shift(), i);
                    var u = bt(e[a], i);
                    u || (u = {}, e[a] = u), e = u, e.then && o.unwrapPromises && (pr(i), "$$v" in e || ! function(e) {
                        e.then(function(t) {
                            e.$$v = t
                        })
                    }(e), e.$$v === n && (e.$$v = {}), e = e.$$v)
            ...
            function Et(e, t, r) {
                ...
                if (t.csp) s = u < 6 ? St(l[0], l[1], l[2], l[3], l[4], r, t) : function(e, i) {
                    var o, a = 0;
                    do o = St(l[a++], l[a++], l[a++], l[a++], l[a++], r, t)(e, i), i = n, e = o; while (a < u);
                    return o
                };
                else {
                    var c = "var p;\n";
                    ...
                    c.prototype = {
                                ...
                                e: do {
                                    if (s = d.$$watchers)
                                        for (u = s.length; u--;) try {
                                            if (r = s[u])
                                                if ((i = r.get(d)) === (o = r.last) || (r.eq ? q(i, o) : "number" == typeof i && "number" == typeof o && isNaN(i) && isNaN(o))) {
                                                    if (r === n) {
                                                        c = !1;
                                                        break e
                                                    }
                                    ...
                                    if (!(h = d.$$childHead || d !== C && d.$$nextSibling))
                                        for (; d !== C && !(h = d.$$nextSibling);) d = d.$parent
                                } while (d = h);
                        ...
                        $emit: function(e, t) {
                            var n, r, i, o = [],
                                ...
                                c = F([u], arguments, 1);
                            do {
                                for (n = s.$$listeners[e] || o, u.currentScope = s, r = 0, i = n.length; r < i; r++)
                                    if (n[r]) try {
                                        n[r].apply(null, c)
                                    } catch (e) {
                                        a(e)
                        ...
                        $broadcast: function(e, t) {
                            for (var n, r, i, o = this, s = o, l = o, u = {
                                ...
                                for (u.currentScope = s, n = s.$$listeners[e] || [], r = 0, i = n.length; r < i; r++)
                                    if (n[r]) try {
                                        n[r].apply(null, c)
                                    } catch (e) {
                                        a(e)
                                    } else n.splice(r, 1), r--, i--;
                                if (!(l = s.$$listenerCount[e] && s.$$childHead || s !== o && s.$$nextSibling))
                                    for (; s !== o && !(l = s.$$nextSibling);) s = s.$parent
                            }
                            return u
                        }
                    };
            ...
            function Qt(e, t, n, r, i) {
                ...
                if (u) i > 0 && e > -1 && e < 1 && (s = e.toFixed(i));
                    ...
                    var d, v = 0,
                        ...
                        y = t.gSize;
                    if (h.length >= g + y)
                        for (v = h.length - g, d = 0; d < v; d++)(v - d) % y === 0 && 0 !== d && (s += n), s += h.charAt(d);
            ...
            var In = ge.cache = {},
                qn = 1,
                Fn = e.document.addEventListener ? function(e, t, n) {
                    e.addEventListener(t, n, !1)
                } : function(e, t, n) {
                    e.attachEvent("on" + t, n)
                },
                Vn = e.document.removeEventListener ? function(e, t, n) {
                ...
                zn = /<|&#?\w+;/,
                Qn = /<([\w:]+)/,
                Xn = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
                Yn = {
                    option: [1, '<select multiple="multiple">', "</select>"],
                    thead: [1, "<table>", "</table>"],
                ...
                ni = function() {
                    return {
                        ...
                        compile: function(e, t) {
                            return ti.test(t.ngValue) ? function(e, t, n) {
                    ...
                    return {
                        ...
                        link: function(r, c, f, p, h) {
                            ...
                            r.$watchCollection(x, function(e) {
                                ...
                                for (v = N.length, p = P.length = N.length, f = 0; f < p; f++)
                                    if (x = e === N ? f : N[f], T = e[x], E = k(x, T, f), oe(E, "`track by` id"), A.hasOwnProperty(E)) D = A[E], delete A[E], j[E] = D, P[f] = D;
                                    else {
                                ...
                                for (f = 0, p = N.length; f < p; f++) {
                                    if (x = e === N ? f : N[f], T = e[x], D = P[f], P[f - 1] && (M = s(P[f - 1])), D.scope) {
                                        b = D.scope, d = M;
                                        do d = d.nextSibling; while (d && d[l]);
                ...
                _i = ["$compile", "$parse", function(e, r) {
                    ...
                    return {
                        ...
                        link: function(s, l, u, c) {
                                ...
                                w && (e(w)(t), w.removeClass("ng-scope"), w.remove()), o.empty(), o.on("change", function() {
                                    t.$apply(function() {
                                        var e, r, i, a, l, c, f, d, v, y = m(t) || [],
                                            x = {};
                                        if (b) {
                                            for (i = [], c = 0, d = A.length; c < d; c++)
                                                for (e = A[c], l = 1, f = e.length; l < f; l++)
                                                    if ((a = e[l].element)[0].selected) {
                                                        if (r = a.val(), h && (x[h] = r), E)
                                                            for (v = 0; v < y.length && (x[p] = y[v], E(t, x) != r); v++);
                                                        else x[p] = y[r];
                                                        i.push(g(t, x))
                                                    }
                            ...
                            if (c[1]) {
                                for (var d, v = c[0], g = c[1], b = u.multiple, x = u.ngOptions, w = !1, C = Cn(t.createElement("option")), S = Cn(t.createElement("optgroup")), T = C.clone(), E = 0, A = l.children(), k = A.length; E < k; E++)
                                    if ("" === A[E].value) {
                                        d = w = A.eq(E);
                                        break
                                    }
    ...
    291: function(e, exports) {
         ...
         */
        "undefined" != typeof e && "undefined" != typeof exports && e.exports === exports && (e.exports = "ui.router"),
            function(e, t, n) {
                "use strict";
                ...
                function l(e, t, n, r) {
                    var i, l = o(n, r),
                        ...
                        c = [];
                    for (var f in l)
                        if (l[f].params && (i = a(l[f].params), i.length))
                            for (var p in i) s(c, i[p]) >= 0 || (c.push(i[p]), u[i[p]] = e[i[p]]);
                    return F({}, u, t)
                }
                ...
                function g(e, t, i) {
                    ...
                    if (x >= 0) {
                        ...
                        if (b = b.substring(0, x), this.sourcePath = e.substring(0, p + x), w.length > 0)
                            for (p = 0; l = c.exec(w);) m = s(l, !0), y = o(m.id, m.type, m.cfg, "search"), p = u.lastIndex
                    ...
                    function x(e, i, o, s, p, d, v) {
                        ...
                        return C.locals = {
                            ...
                            var k = t.path,
                                ...
                                P = [];
                            if (!o.reload)
                                for (; O && O === h[D] && O.ownParams.$$equals(n, p);) M = P[D] = O.locals, D++, O = k[D];
                ...
                xml2json: function(e, t) {
                    function n(e, o) {
                        ...
                        e.childNodes && e.childNodes.length > 0 && $.each(e.childNodes, function(e, t) {
                            ...
                            if (8 != o)
                                if (3 != o && 4 != o && l) s = s || {}, s[l] ? (s[l].length || (s[l] = i(s[l])), s[l] = i(s[l]), s[l][s[l].length] = n(t, !0), s[l].length = s[l].length) : s[l] = n(t);
                                else {
                                    if (u.match(/^\s+$/)) return;
            ...
            var a = !1,
                ...
                f = function(e, r) {
                    u.scroll || (u.log("Init jQuery Scrollbar v0.2.6"), u.overlay = i(), u.scroll = n(), d(), $(t).resize(function() {
                            ...
                            d(e)
                        })), this.container = e, this.options = $.extend({}, c, t.jQueryScrollbarOptions || {}), this.scrollTo = null, this.scrollx = {}, this.scrolly = {},
                        this.init(r)
                };
            f.prototype = {
                destroy: function() {
                ...
                return "get" === e && (n = null), this.each(function() {
                    ...
                    if (i) {
                        ...
                        if (i[o].apply(i, $.isArray(t) ? t : []), "destroy" === e)
                            for (r.removeData("scrollbar"); $.inArray(i, u.scrolls) >= 0;) u.scrolls.splice($.inArray(i, u.scrolls), 1)
                    } else "string" != typeof e && (i = new f(r, e), r.data("scrollbar", i), u.scrolls.push(i));
                    return !0
                }), n
            }, $.fn.scrollbar.options = c, t.angular && ! function(e) {
            ...
            $.Range = function(e) {
                    ...
                    moveToPoint: function(e) {
                        ...
                        for (var a = document.elementFromPoint(t, n), s = 0; s < a.childNodes.length; s++) {
                            ...
                            if (3 === l.nodeType || 4 === l.nodeType)
                                for (var u = $.Range(l), c = u.toString().length, f = 1; f < c + 1; f++) {
                                    var p = u.end(f).rect();
                    ...
                    start: function(e) {
                        ...
                        if (this.range.setStart)
                            if ("number" == typeof e) this.range.setStart(this.range.startContainer, e);
                        ...
                        if (this.range.setEnd)
                            if ("number" == typeof e) this.range.setEnd(this.range.endContainer, e);
                            else if ("string" == typeof e) {
                ...
                function() {
                    ...
                    }, n.select = r.selectNodeContents ? function(e) {
