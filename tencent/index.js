webpackJsonp([1], {
    ...
    297: function(e, exports, t) {
        angular.module("Controllers", []), t(298), t(299), t(300), t(302), t(303), t(305), t(306), t(307), t(308), t(309), t(310), t(311), angular.module("Services", []), t(312), t(313), t(314), t(315), t(316), t(317), t(318), t(319), t(320), t(321), t(322), t(323), t(324), t(325), t(326), t(327), t(328), t(329), t(330), t(331), angular.module("Directives", []), t(332), t(333), t(334), t(335), t(336), t(337), t(338), t(339), t(340), t(341), t(342), t(343), t(344), t(345), t(346), t(347), t(348), t(349), t(350), t(351), t(352), t(353), t(354), t(355), t(356), angular.module("Filters", []), t(358), t(359),
            function() {
                "use strict";
    ...
    298: function(e, exports) {
        ! function() {
            ...
            location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function() {
            ...
            }]) : angular.module("exceptionOverride", []), angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService", function(e, t, a, n, i, o, c, r, s, l, d, f, u, m, g, p, h, M, v, y, b, C) {
                function w() {
                ...
                function T() {
                    t.isLoaded = !0, t.isUnLogin = !1, M.report(M.ReportType.timing, {
                        ...
                        f.setUserInfo(n.User), f.setSkey(n.SKey), f.setSyncKey(n.SyncKey), d.addContact(n.User), d.addContacts(n.ContactList), u.initChatList(n.ChatSet), u.notifyMobile(f.getUserName(), m.StatusNotifyCode_INITED), b.init(n.MPSubscribeMsgList), e.$broadcast("root:pageInit:success"), h.setCheckUrl(f), h.log("getUserInfo", f.getUserInfo()), t.$broadcast("updateUser"), M.report(M.ReportType.timing, {
                            timing: {
                                initEnd: Date.now()
                            }
                        });
                ...
                window._appTiming = {};
                i.go("chat"), e.CONF = m, t.isUnLogin = !window.MMCgi.isLogin, t.debug = !0, t.isShowReader = /qq\.com/gi.test(location.href), window.MMCgi.isLogin && (T(), h.browser.chrome && !MMDEV && (window.onbeforeunload = function(e) {
            ...
            angular.module("Controllers").controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", function(e, t, a, n) {
                ...
                function o() {
                    t.getUUID().then(function(o) {
                        a.log("login", o), e.uuid = o, e.qrcodeUrl = "https://login.weixin.qq.com/qrcode/" + o, e.code = 0, e.isScan = !1, e.isIPad = a.isIPad, e.isMacOS = a.isMacOS, e.isWindows = a.isWindows, e.lang = a.queryParser().lang || "zh_CN";
                        var c = !1;
            ...
            angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function(e, a, n, i, o, c, r, s, l, d, f, u, m, g, p, h, M, v, y) {
                ...
                e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, o.find("#chatArea").on("drop", function(e) {
                    ...
                    u - t.pageX < r && (M = t.pageX - r), m - t.pageY < d && (h = t.pageY - d), g.open({
                        ...
                        singletonId: "mmpop_profile",
                        controller: ["$scope", function(e) {
                            e.contact = o, e.MMDefaultRemark = _("8d521cc"), e.addUserContent = _("5a97440") + y.formatHTMLToSend(s.getUserInfo().NickName), e.isShowSendBox = i || !1, e.chat = function(t) {
                                n.go("chat", {
                                    userName: t
                                }), e.closeThisMmPop()
                            ...
                            setTimeout(function() {
                                ...
                                if (n.MsgType == f.MSGTYPE_EMOTICON || n.MsgType == f.MSGTYPE_IMAGE || n.MsgType == f.MSGTYPE_VIDEO) {
                                    ...
                                    var r = a.find(".content .msg-img"),
                                        s = r.height(),
                                        l = {};
                                    if (n.ImgHeight) n.MsgType == f.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * r.width() / n.ImgWidth + "px", l.widht = r.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth), n.MMImgStyle = l, t.$digest(), i(a.height()), t.$destroy(), a.remove();
    ...
    303: function(e, exports, t) {
        ! function() {
            ...
            angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function(e, a, n, i, o, c, r, s, l, d, f, u, m, g, p) {
                ...
                function b(e) {
                    var t, a, n = "";
                    if (window.getSelection) t = window.getSelection(), t.rangeCount > 0 && (a = t.getRangeAt(0).cloneRange(), a.collapse(!0), a.setStart(x, 0), n = a.toString().slice(-e));
                    ...
                    _sendFileUserName, service = {
                        ...
                        addChatList: function(e) {
                            ...
                            e && (angular.isArray(e) || (e = [e]), angular.forEach(e, function(e, t) {
                                var a = "",
                                    n = 0;
                                if (a = e.UserName ? e.UserName : e.FromUserName == accountFactory.getUserInfo().UserName ? e.ToUserName : e.FromUserName, n = _chatList.indexOf(a), n == -1) _chatList.unshift(a), utilFactory.isRoomContact(a) && contactFactory.addBatchgetChatroomContact(a);
                                else {
                    ...
                    G = {
                        ...
                        canSearch: function(e, t) {
                            ...
                            var a = this.RemarkName || "",
                                ...
                                s = 0,
                                l = 0;
                            return s = a.toUpperCase().indexOf(e), l = n.toUpperCase().indexOf(e), s >= 0 || l >= 0 || (s = i.toUpperCase().indexOf(e), l = o.toUpperCase().indexOf(e), s >= 0 || l >= 0 || (c.toUpperCase().indexOf(e) >= 0 || r.toUpperCase().indexOf(e) >= 0))
                        },
                        update: function(e) {
                    ...
                    k = {
                        ...
                        addBatchgetContact: function(e, t, i) {
                            function c(e) {
                                ...
                                }), u.addContacts(e.ContactList, !0), C = [], !C.length && b.length > 0 && u.batchGetContact().then(c, s)
                            }
                        ...
                        getContactOrderSymbol: function(e) {
                            if (!e) return "";
                            var t = "";
                            return t = r.clearHtmlStr(e.RemarkPYQuanPin || e.PYQuanPin || e.NickName || "").toLocaleUpperCase().replace(/\W/gi, ""), t.charAt(0) < "A" && (t = "~"), t
                        },
    ...
    322: function(e, exports) {
        ! function() {
            ...
            angular.module("Services").factory("screenShotFactory", ["confFactory", "reportService", function(e, t) {
                ...
                function c(a, i) {
                    var c = n();
                    c.StopUpload(), c.ClearHeaders(), c.ClearFormItems(), c && (c.URL = (MMDEV ? "http://wx.qq.com" : "http://" + location.hostname) + e.API_webwxpreview + "?fun=upload", c.AddHeader("Cookie", document.cookie), c.AddFormItem("msgimgrequest", 0, 0, a), c.AddFormItem("filename", 1, 4, o()), c.OnEvent = function(e, a) {
                        switch (a) {
                            case 2:
                                break;
                            case 3:
        ...
        ! function() {
            ...
            angular.module("Services").factory("notificationFactory", ["utilFactory", function(e) {
                ...
                function r(e, n) {
                    ...
                    var o, r;
                    return g && c() && angular.isString(e) && n && (angular.isString(n.icon) || angular.isObject(n.icon)) && i() === l && (o = t(e, n)), r = a(o), h.push(r), M.autoClose && o && !o.ieVerification && o.addEventListener && o.addEventListener("show", function() {
                        var e = r;
                        setTimeout(function() {
                            e.close()
                        }, M.autoClose)
                                ...
                                jQuery(o).jPlayer({
                                    ready: function() {
                                        jQuery(this).jPlayer("setMedia", {
                                            ...
                                            poster: c.poster
                                        }), c.muted !== e && jQuery(this).jPlayer("mute"), c.loop !== e && u && (jQuery(this).jPlayer("play"), s())
                                    },
                                    click: function() {
                ...
                this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function(d, f, u, m, g, p, h, M, v) {
                    ...
                    var b = {
                            ...
                            performCloseDialog: function(t, n) {
                                ...
                                1 === o && y.unbind("keydown"), t.hasClass("ngdialog-closing") || (o -= 1), p.$broadcast("ngDialog.closing", t), c ? t.unbind(r).bind(r, function() {
        ...
        angular.module("Directives").directive("contactPicker", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "mmpop", function(e, t, a, n, i, o, c, r, s, l, d, f, u) {
            ...
            return {
                ...
                link: function(t, a, n) {
                    ...
                    h.opt.all = h.opt.all || {};
                    var M = t.initList || [];
                    t.contactList = o(r.pickContacts(h.types, h.opt, !0).result, M), t.selectList = t.selectList || [], s(), t.search = function(a) {
